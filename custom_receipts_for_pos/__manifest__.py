...
###################################################################################
{
    ...
    'maintainer': 'Prosys Techno Solutions',
    'website': "https://www.Prosys.com",
    'depends': ['base', 'point_of_sale','l10n_sa_pos','crm','sales_team'],
    'data': [
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'custom_receipts_for_pos/static/src/js/qrcode.js',
            'custom_receipts_for_pos/static/src/js/sale_team_1.js',
            'custom_receipts_for_pos/static/src/js/sale_team_2.js',
